...
export function SectionCards() {
  return (
    <div
      ...
      <Card className="@container/card">
        <CardHeader>
          <CardDescription className="text-[#5c6f91]">New Customers</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            1,234
          </CardTitle>
          <CardAction>
            <Badge className="text-[#101828]" variant="outline">
              <IconTrendingDown />
              -20%
            </Badge>
          </CardAction>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="text-[#101828] line-clamp-1 flex gap-2 font-medium">
            Down 20% this period <IconTrendingDown className="text-[#101828] size-4" />
          </div>
          <div className="text-[#5c6f91] text-muted-foreground">
      ...
      <Card className="@container/card">
        <CardHeader>
          <CardDescription  className="text-[#5c6f91]">Active Accounts</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            45,678
          </CardTitle>
          <CardAction>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="text-[#101828] line-clamp-1 flex gap-2 font-medium">
            Strong user retention <IconTrendingUp className="text-[#101828] size-4" />
          </div>
      ...
      <Card className="@container/card">
        <CardHeader>
          <CardDescription  className="text-[#5c6f91]">Growth Rate</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            4.5%
          </CardTitle>
          <CardAction>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="text-[#101828] line-clamp-1 flex gap-2 font-medium">
            Steady performance increase <IconTrendingUp className="text-[#101828] size-4" />
          </div>
