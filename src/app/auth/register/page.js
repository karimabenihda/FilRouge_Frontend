    ...
    <section className="relative flex flex-col md:flex-row justify-center px-4 py-5 lg:py-10 gap-14 md:gap-20 mx-auto">
      ...
      <div className="text-center lg:pt-15 md:text-left mt-1 px-2">
        <div className="flex items-center p-1.5 rounded-full border border-[#c8ad93] text-xs w-fit mx-auto md:mx-0 mb-4">
          <div className="flex -space-x-2">
            {[
              ...
              <img key={i} className="w-7 h-7 rounded-full border border-[#c8ad93]" src={src} alt="" />
            ))}
          </div>
        ...
        <p className="text-sm md:text-lg max-w-md mt-4 mx-auto md:mx-0">
          Let our design team guide you in choosing the perfect furniture for your home.
          Fill out the form and start your journey today.
        </p>
      </div>

      {/* Form */}
      <div className="w-full max-w-lg mx-auto bg-gray-50 border border-[#c8ad93]/30 rounded-xl p-6 md:p-8 shadow-lg">
        <h2 className="font-bold text-3xl text-[#1e3753] text-center md:text-left">Register</h2>
        <p className="text-sm mt-2 text-[#1e3753] text-center md:text-left">
          Let's create your account
        </p>

        <form className="flex flex-col gap-4 pt-7" onSubmit={handleSubmit}>
          ...
          <Button type="submit" disabled={isLoading} className="bg-[#1e3753] hover:bg-[#2a4a6d]">
            {isLoading
        ...
        <div className="mt-4 text-sm flex flex-col md:flex-row gap-2 md:gap-0 justify-between items-center">
          <p className="text-[#1e3753]">
            Already have an account?{" "}
            <a href="/auth/login" className="text-[#c8ad93] underline">Login here</a>
          </p>
        </div>
      </div>
    </section>
